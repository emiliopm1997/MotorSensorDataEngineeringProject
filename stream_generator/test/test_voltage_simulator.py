...
class TestVoltageSimulator(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.simulator = VoltageSensorSimulator(
            t_cycle=2,
            peak=10,
            base=0
        )
    ...
    def test_simulated_voltage(self):
        ...
        exp_array = np.array([
            4.76566084e-07, 9.84807805e+00, 0.00000000e+00, 0.00000000e+00,
            6.42788039e+00, 6.42788179e+00, 0.00000000e+00, 0.00000000e+00,
            9.84807774e+00, 2.30485229e-06
        ])
